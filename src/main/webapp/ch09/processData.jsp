...
<%@ page import="com.javalab.vo.*" %>
    <%
    	...
    	if("movie".equals(infoType)){
    		...
    		albumList.add(new Album("엘범1", "작곡가1", 2020));
    		albumList.add(new Album("엘범2", "작곡가2", 2021));
    		albumList.add(new Album("엘범3", "작곡가3", 2022));
    		albumList.add(new Album("엘범4", "작곡가4", 2023));
    		albumList.add(new Album("엘범5", "작곡가5", 2024));
